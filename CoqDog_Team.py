...
def ask_coqdog(context_added, model_choice, conversation_history_json, display_mode, use_recommendation, n_clicks,
    ...
    if not conversation_history:
        conversation_history = [{'role': 'system',
                                 ...
                                 If the user is using gpt-4o, you may process images and display them. Remember to use\
                                  ...
                                  You must provide a response solely as a proof, with format\n
                                  ```coq\n
                                  ...
                                  Qed.\n
                                  ```\n
                                  This format is required for your response to be accepted.\n
                                  All other responses will be discarded.\n
                                   """}]
        context_added = "false"
    ...
    ###
    # Manual modification to get CoqDog to just dump the response from GPT
    ###
